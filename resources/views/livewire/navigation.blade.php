<nav class="bg-gradient-to-br from-yellow-800 via-purple-700 to-yellow-500">
    <div class="container mx-auto px-4 py-2 flex items-center justify-between">
        <div class="flex items-center space-x-4">
            ...
            <div class="relative">
                <input type="text" placeholder="Buscar..."
                    class="rounded-full pl-4 pr-10 py-2 bg-zinc-100 dark:bg-zinc-700 text-white dark:text-white focus:outline-none">
        ...
        <div class="flex items-center space-x-4">
          ...
          <span class="ml-1">Entrar</span>
            ...
            <!-- Ejemplo en cualquier vista donde aparezca el botón del carrito -->
    ...
    <div class="bg-gradient-to-br from-gray-900 to-gray-500">
        <div class="container mx-auto px-4 py-2 flex space-x-4 text-white dark:text-white">
            <a href="#" class="relative inline-block text-yellow-400">
                <b>Comprar todo</b>
            ...
            <a href="{{ url('drones_camaras') }}" class="relative inline-block hover:text-yellow-300  ">Drones y
                cámaras</a>
            <a href="{{ url('audio') }}" class="relative inline-block hover:text-yellow-300  ">Audio</a>
            <a href="{{ url('celulares') }}" class="relative inline-block hover:text-yellow-300  ">Celulares</a>
            <a href="{{ url('tvcine') }}" class="relative inline-block hover:text-yellow-300  ">T.V. y cine en casa</a>
            <a href="{{ url('portatiles') }}" class="relative inline-block hover:text-yellow-300  ">Tecnología
                portátil</a>
